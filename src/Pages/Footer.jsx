                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                        <div className="sm:col-span-2">
                            ...
                            <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
                                <input type="text" name="email" className="px-4 py-2 text-gray-700 bg-white border rounded-md  " placeholder="Email Address" />

                                <button className="w-full px-6 py-2.5 text-sm font-medium tracking-wider text-white transition-colors duration-300 transform md:w-auto md:mx-4 bg-blue-800 rounded-lg hover:bg-blue-900">
                                    Subscribe
                                </button>
                            </div>
                        </div>
